...
CREATE TABLE `ams_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COMMENT='管理员';
...
CREATE TABLE `ams_admin_role` (
  ...
  `gmt_modified` datetime DEFAULT NULL COMMENT '数据最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='管理员角色关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ams_role` VALUES (1,'系统管理员','最高权限的管理员角色，应该关联所有权限',255,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(2,'超级管理员','除了系统管理员以外的最高权限的管理员角色，应该关联除了【管理员管理】以外的所有权限',255,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(3,'商品管理员','负责商品管理的管理员角色，应该关联与商口相关的所有权限',99,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(4,'品牌管理员','负责管理品牌的管理员角色，应该关联品牌管理的相关权限',0,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(5,'分类管理员','负责管理类别的管理员角色，应该关联类别管理的相关权限',0,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(6,'相册管理员','负责管理图片、相册的管理员角色，应该关联图片管理、相册管理的相关权限',0,'2022-07-08 11:30:44','2022-07-08 11:30:44'),(7,'武清源','不知道',1,NULL,NULL),(8,'武清源','不知道',1,NULL,NULL);
...
INSERT INTO `user` VALUES (1,1,'xiaoming');
...
-- Dump completed on 2022-12-20 10:44:35
